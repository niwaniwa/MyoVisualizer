...
namespace CaioCs
{
	...
	public class Caio
	{
		...
		[DllImport("caio.dll")] static extern int AioSingleAiSR(short Id, short AiChannel, ref int AiData, ref ushort Timestamp, byte Mode);
		[DllImport("caio.dll")] static extern int AioSingleAiExSR(short Id, short AiChannel, ref float AiData, ref ushort Timestamp, byte Mode);
		[DllImport("caio.dll")] static extern int AioMultiAiSR(short Id, short AiChannels, [MarshalAs(UnmanagedType.LPArray)] int[] AiData, ref ushort Timestamp, byte Mode);
		[DllImport("caio.dll")] static extern int AioMultiAiExSR(short Id, short AiChannels, [MarshalAs(UnmanagedType.LPArray)] float[] AiData, ref ushort Timestamp, byte Mode);
		...
		[DllImport("caio.dll")] unsafe static extern int AioSetAiCallBackProc(short Id, IntPtr pAiCallBack, int AiEvent, void *Param);
		...
		[DllImport("caio.dll")] static extern int AioSetAiDigitalFilter(short Id, short AiChannel, short FilterType, short FilterValue);
		[DllImport("caio.dll")] static extern int AioGetAiDigitalFilter(short Id, short AiChannel, ref short FilterType, ref short FilterValue);
		...
		[DllImport("caio.dll")] unsafe static extern int AioSetAoCallBackProc(short Id, IntPtr pAoCallBack, int AoEvent, void *Param);
		...
		[DllImport("caio.dll")] unsafe static extern int AioSetCntCallBackProc(short Id, short CntChannel, IntPtr pCntCallBack, int CntEvent, void *Param);
		...
		[DllImport("caio.dll")] unsafe static extern int AioSetTmCallBackProc(short Id, short TimerId, IntPtr pTmCallBack, int TmEvent, void *Param);
		...
		[DllImport("caio.dll")] unsafe static extern int AioCntmCountUpCallbackProc(short Id , IntPtr pAioCntmCountUpCallBack, void *Param);
		...
		[DllImport("caio.dll")] unsafe static extern int AioCntmCounterErrorCallbackProc(short Id, IntPtr pAioCntmCounterErrorCallBack, void *Param);
		...
		[DllImport("caio.dll")] unsafe static extern int AioCntmCarryBorrowCallbackProc(short Id, IntPtr pAioCntmCarryBorrowCallBack, void *Param);
		...
		[DllImport("caio.dll")] unsafe static extern int AioCntmTimerCallbackProc(short Id, IntPtr pAioCntmTmCallBack, void *Param);
		...
		public int SingleAiSR(short Id, short AiChannel, out int AiData, out ushort Timestamp, byte Mode)
		{
			AiData = 0;
			Timestamp = 0;
			int ret = AioSingleAiSR(Id, AiChannel, ref AiData, ref Timestamp, Mode);
			return ret;
		}
		public int SingleAiExSR(short Id, short AiChannel, out float AiData, out ushort Timestamp, byte Mode)
		{
			AiData = 0;
			Timestamp = 0;
			int ret = AioSingleAiExSR(Id, AiChannel, ref AiData, ref Timestamp, Mode);
			return ret;
		}
		public int MultiAiSR(short Id, short AiChannels, int[] AiData, out ushort Timestamp, byte Mode)
		{
			Timestamp = 0;
			int ret = AioMultiAiSR(Id, AiChannels, AiData, ref Timestamp, Mode);
			return ret;
		}
		public int MultiAiExSR(short Id, short AiChannels, float[] AiData, out ushort Timestamp, byte Mode)
		{
			Timestamp = 0;
			int ret = AioMultiAiExSR(Id, AiChannels, AiData, ref Timestamp, Mode);
			return ret;
		}
		...
		public int SetAiDigitalFilter(short Id, short AiChannel, short FilterType, short FilterValue)
		{
			int ret = AioSetAiDigitalFilter(Id, AiChannel, FilterType, FilterValue);
			return ret;
		}
		public int GetAiDigitalFilter(short Id, short AiChannel, out short FilterType, out short FilterValue)
		{
			FilterType = 0;
            FilterValue = 0;
            int ret = AioGetAiDigitalFilter(Id, AiChannel, ref FilterType, ref FilterValue);
			return ret;
		}
